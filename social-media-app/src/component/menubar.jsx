...
import { Home, Search, Compass, PlusCircle, Bell, X, Search as SearchIcon,MessageCircleMore } from 'lucide-react';
...
export default function VerticalMenu() {
  ...
  return (
    <>
      {/* Sidebar Menu */}
      <div className="flex flex-col w-64 h-screen bg-gray-100 shadow-lg p-4">
        {/* App Name */}
